                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        @can('product_categories.create')
                            <a href="{{ route('admin.sub-categories.create')}}" class="btn btn-primary btn-sm btn_modal add_btn">{{ __('Add Sub Category') }}</a>
                        @endif
                    </div>
                </div>                                                   
            </div>                          
...
<script type="text/javascript">
    ...
    function get_data(page=null){
      ...
      let url = "{{ route('admin.sub-categories.index') }}?page="+page;
