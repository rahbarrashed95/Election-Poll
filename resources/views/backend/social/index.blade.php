...
<div class="page-header">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Social List</li>
    </ol>
  </nav>
</div>
<div class="row">                                 
        ...
        <div class="row" style="margin-bottom: 15px;">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        @can('social.create')
                            <a href="{{ route('admin.social.create')}}" class="btn btn-primary btn-sm btn_modal add_btn">{{ __('Add Social') }}</a>
                        @endif
                    </div>
                </div>                                                   
            </div>                          
...
<script type="text/javascript">
    ...
    function get_data(page=null){
      ...
      let url = "{{ route('admin.social.index') }}?page="+page;
