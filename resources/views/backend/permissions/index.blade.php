            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-5">
                            ...
                            <a href="{{ route('admin.permissions.create')}}" class="btn btn-primary btn-sm btn_modal add_btn">{{ __('Add Permission') }}</a>
...
<script type="text/javascript">
    ...
    function get_data(page=null){
      ...
      let url = "{{ route('admin.permissions.index') }}?page="+page;
