                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        @can('product_categories.create')
                            <a href="{{ route('admin.testimonials.create')}}" class="btn btn-primary btn-sm btn_modal add_btn">{{ __('Add Testimonial') }}</a>
                        @endif
                    </div>
                </div>                                                   
            </div>                          
...
<script type="text/javascript">
    ...
    function get_data(page=null){
      ...
      let url = "{{ route('admin.testimonials.index') }}?page="+page;
