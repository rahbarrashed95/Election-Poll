...
<div class="page-header">
  <h3 class="page-title"> Amenity </h3>
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="#">Amenity</a></li>
      <li class="breadcrumb-item active" aria-current="page">Amenity List</li>
    </ol>
  </nav>
</div>
<div class="row">                                 
        ...
        <div class="row" style="margin-bottom: 15px;">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        @can('social.create')
                            <a href="{{ route('admin.amenity-property.create')}}" class="btn btn-primary btn-sm btn_modal add_btn">{{ __('Add Amenity') }}</a>
                        @endif
                    </div>
                </div>                                                   
            </div>                          
...
<script type="text/javascript">
    ...
    function get_data(page=null){
      ...
      let url = "{{ route('admin.amenity-property.index') }}?page="+page;
