...
<div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <form action="{{route('admin.cities.store')}}" method="POST" enctype="multipart/form-data" id="ajax_form">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="city" class="form-control" name="city" placeholder="City Name..." value="">
                            </div>
                        </div>   
