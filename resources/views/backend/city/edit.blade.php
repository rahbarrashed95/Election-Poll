...
<div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <form action="{{route('admin.cities.update',[$item->id])}}" method="POST" enctype="multipart/form-data" id="ajax_form">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="city" class="form-control" name="city" placeholder="City Name..." value="{{ $item->city }}">
                            </div>
                        </div>    
