...
<!-- Mirrored from dreamsestate.dreamstechnologies.com/html/rent-property-grid-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Mar 2025 09:03:14 GMT -->
<head>
	...
	<body>
                        ...
                        <ul class="main-nav">
                            ...
                            <li class="has-submenu active">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="has-submenu">
                                        <a href="javascript:void(0);" class="active">Rent Property</a>
                                        <ul class="submenu">
                                            <li><a href="rent-property-grid.html">Rent  Grid</a></li>
                                            <li><a href="rent-property-list.html">Rent  List</a></li>
                                            <li><a href="rent-property-grid-sidebar.html" class="active">Rent Grid With Sidebar</a></li>
                ...
                <div class="container">
                    <div class="bread-crumb-head">
                        <div class="breadcrumb-title">
                            <h2>Rent Property Grid with Sidebar</h2>
                        </div>
                        <div class="breadcrumb-list">
                            <ul>
                                <li><a href="index.html">Home </a></li>
                                <li>Rent Property Grid with Sidebar</li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-9">
                                <div class="sort-result">
                                    ...
                                    <div class="grid-list-view">
                                        <ul>
                                            <li><a href="rent-property-grid-sidebar.html" class="active"><i class="bx bx-grid"></i></a></li>
                                            <li><a href="rent-property-list-sidebar.html"  ><i class="bx bx-list-ul"></i></a></li>
									...
									<div id="pricing" class="card-collapse collapse show">
                                        <ul class="price-filter">
                                            <li class="d-flex justify-content-between">
                                                <div class="caption"><h5>Price Range : </h5>
                                        ...
                                        <div class="profile-widget">
                                            ...
                                            <div class="pro-content">
                                                ...
                                                <ul class="property-category d-flex justify-content-between align-items-center">
                                                    <li class="user-info">
                                                    <a href="agent-grid.html"><img src="assets/img/profiles/avatar-01.jpg" class="img-fluid avatar" alt="User"></a>
                                                        <div class="user-name">
                                    ...
                                    <div class="product-custom">
                                        <div class="profile-widget">
                                            ...
                                            <div class="pro-content">
                                                ...
                                                <ul class="property-category d-flex justify-content-between align-items-center">
                                                    <li class="user-info">
                                                        <a href="agent-grid.html"><img src="assets/img/profiles/avatar-02.jpg" class="img-fluid avatar" alt="User"></a>
                                                        <div class="user-name">
                                                            <a href="agent-grid.html">Karen Maria</a>
                                                            <p>South Dokata</p>
                                                        </div>													
                                                    </li>
                                                    <li>
                                    ...
                                    <div class="product-custom">
                                        <div class="profile-widget">
                                            ...
                                            <div class="pro-content">
                                                ...
                                                <ul class="property-category d-flex justify-content-between align-items-center">
                                                    <li class="user-info">
                                                        <a href="agent-grid.html"><img src="assets/img/profiles/avatar-03.jpg" class="img-fluid avatar" alt="User"></a>
                                                        <div class="user-name">
                                                            <a href="agent-grid.html">Scott Gwin</a>
                                                            <p>Minipoliies</p>
                                                        </div>													
                                                    </li>
                                                    <li>
                                    ...
                                    <div class="product-custom">
                                        <div class="profile-widget">
                                            ...
                                            <div class="pro-content">
                                                ...
                                                <ul class="property-category d-flex justify-content-between align-items-center">
                                                    <li class="user-info">
                                                        <a href="agent-grid.html"><img src="assets/img/profiles/avatar-04.jpg" class="img-fluid avatar" alt="User"></a>
                                                        <div class="user-name">
                                                            <a href="agent-grid.html">Burdette</a>
                                                            <p>Cambridge</p>
                                                        </div>													
                                                    </li>
                                                    <li>
                                    ...
                                    <div class="product-custom">
                                        <div class="profile-widget">
                                            ...
                                            <div class="pro-content">
                                                ...
                                                <ul class="property-category d-flex justify-content-between align-items-center">
                                                    <li class="user-info">
                                                        <a href="agent-grid.html"><img src="assets/img/profiles/avatar-05.jpg" class="img-fluid avatar" alt="User"></a>
                                                        <div class="user-name">
                                                            <a href="agent-grid.html">Kell Robinson</a>
                                                            <p>USA</p>
                                                        </div>													
                                                    </li>
                                                    <li>
		...
		<!-- jQuery -->
		<script src="{{asset('public/frontend/assets/js/jquery-3.7.1.min.js')}}" type="2f166feff4192e0a98bb74f6-text/javascript"></script>
		
		<!-- Bootstrap Bundle JS -->
		<script src="{{asset('public/frontend/assets/js/bootstrap.bundle.min.js')}}" type="2f166feff4192e0a98bb74f6-text/javascript"></script>
		
		<!-- Feather Icon JS -->
		<script src="{{asset('public/frontend/assets/js/feather.min.js')}}" type="2f166feff4192e0a98bb74f6-text/javascript"></script>

		<!-- Owl Carousel JS -->
		<script src="{{asset('public/frontend/assets/js/owl.carousel.min.js')}}" type="2f166feff4192e0a98bb74f6-text/javascript"></script>

        <!-- Slider Rrange  JS -->
        <script src="{{asset('public/frontend/assets/plugins/range-slider/slider-range.js')}}" type="2f166feff4192e0a98bb74f6-text/javascript"></script>

		<!-- Sticky Sidebar JS -->
		<script src="{{asset('public/frontend/assets/plugins/theia-sticky-sidebar/ResizeSensor.js')}}" type="2f166feff4192e0a98bb74f6-text/javascript"></script>
		<script src="{{asset('public/frontend/assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js')}}" type="2f166feff4192e0a98bb74f6-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="{{asset('public/frontend/assets/plugins/select2/js/select2.min.js')}}" type="2f166feff4192e0a98bb74f6-text/javascript"></script>

		<!-- Custom JS -->
		<script src="{{asset('public/frontend/assets/js/script.js')}}" type="2f166feff4192e0a98bb74f6-text/javascript"></script>
        <script src="{{asset('public/frontend/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js')}}" data-cf-settings="ef363f6faa40ed29af84ad60-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"91b79ad2bd2a3366","version":"2025.1.0","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
