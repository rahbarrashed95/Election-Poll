...
<div class="page-header">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Seat List</li>
    </ol>
  </nav>
</div>
<div class="row">                                 
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        @can('product_categories.create')
                            <a href="{{ route('admin.seats.create')}}" class="btn btn-primary btn-sm btn_modal add_btn">{{ __('Add Seat') }}</a>
                        @endif
                    </div>
                </div>                                                   
            </div>                          
...
<script type="text/javascript">
    ...
    function get_data(page=null){
      ...
      let url = "{{ route('admin.seats.index') }}?page="+page;
